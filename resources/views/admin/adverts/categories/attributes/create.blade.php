...
@section('content')
    ...
    <form method="post" action="{{route('admin.adverts.categories.attributes.store',$category)}}">
        ...
        <div class="form-group">
            ...
            <input id="sort" name="sort" type="text" class="form-control{{$errors->has('sort') ? ' is_invalid' : ''}}"  value="{{old('sort')}}" required >
            @if($errors->has('sort'))
        ...
        <div class="form-group">
            ...
            <textarea name="variants" id="variants" type="text" class="form-control{{$errors->has('sort') ? ' is-invalid': ''}}" >
                {{old('variants')}}
            </textarea>
