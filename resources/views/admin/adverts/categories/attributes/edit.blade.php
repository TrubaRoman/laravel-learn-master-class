...
@section('content')
    ...
    <form  method="POST"  action="{{route('admin.adverts.categories.attributes.update',[$category,$attribute])}}">
        ...
        <div class="form-group">
            ...
            <input id="name" class="form-control{{$errors->has('name') ? ' is_invalid': ''}}" name="name" value="{{old('name',$attribute->name)}}" required>
            @if($errors->has('name'))
        ...
        <div class="form-group">
            ...
            <input id="sort" class="form-control{{$errors->has('sort') ? ' is_invalid' : ''}}" name="sort" value="{{old('sort',$attribute->sort)}}" required>
            @if($errors->has('sort'))
        ...
        <div class="form-group">
            <label for="parent" class="col-form-label"> Type</label>
            <select id="parent" class="form-control{{$errors->has('type') ? ' is_invalid': ''}}" name="type" >
